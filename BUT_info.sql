...
(
	...
	CONSTRAINT _correspond_fk1 FOREIGN KEY (code_P)
        REFERCENCES _parcours(code_P),
    CONSTRAINT _correspond_fk1 FOREIGN KEY (numero_N)
        REFERCENCES _niveau(numero_N),
    CONSTRAINT _correspond_fk1 FOREIGN KEY (lib_activite)
        REFERCENCES _activites(lib_activite)
);
